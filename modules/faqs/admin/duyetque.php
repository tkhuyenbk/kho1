...
while ($row = $query2->fetch())
{
    ...
    $array[$row['qid']] = array(//
        'qid' => $row['qid'], //
        'addtime' => nv_date('d.n.Y', $row['addtime']), //
        'status' => $row['status'], //
        'title' => $row['title'], //
        'sort' => $i, //
        'cus_name' => $row['cus_name'], //
        'cus_email' => $row['cus_email'], //
        'detail_url' => NV_BASE_ADMINURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&" . NV_NAME_VARIABLE . "=" . $module_data . "&" . NV_OP_VARIABLE . "=de&qid=" . $row['qid']);
}
